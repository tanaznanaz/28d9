--!strict
-- Steal An Egg Matcha port: NightHub Egg Port
-- Standalone raw script. Upload this file to GitHub, then load with loadstring(httpget(raw_url))().

local env = getfenv()
local ui = env and env.UI

local SCRIPT_TITLE = "NightHub Egg Port"
local API_KEY = "NightHubEggPort"
local TAB_NAME = "NightHub Egg"
local ID = "nighthub_egg_"
